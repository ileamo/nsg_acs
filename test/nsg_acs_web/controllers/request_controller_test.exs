defmodule NsgAcsWeb.RequestControllerTest do
  use NsgAcsWeb.ConnCase

  alias NsgAcs.RequestLog

  @create_attrs %{from: "some from", request: %{}, response: "some response"}
  ...
  def fixture(:request) do
    {:ok, request} = RequestLog.create_request(@create_attrs)
    request
  end
